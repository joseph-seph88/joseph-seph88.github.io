    ...
    return (
        <>
            <div className="text-left mb-2 mt-15">
                <h2 className="font-thin text-3xl text-gray-800">Problem-Solving Experience</h2>
            </div>
            <div className="border-b-2 border-gray-200 mb-8"></div>

            <div className="flex gap-12 mb-8">
                <div className="flex-none w-60">
                    <p className="text-gray-400 italic mt-20 ml-2"><strong>비정상적인 동작이 생기면 원인과 맥락을 꼭 파악하려고 한다. 그래야 비슷한 상황에서 실수를 줄일 수 있다.</strong></p>
                </div>
