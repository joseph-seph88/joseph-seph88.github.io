    ...
    <>
      ...
      <div className="flex items-start gap-8 mb-8">
        ...
        <div className="flex-1">
          ...
          <ol>
            <li><strong>아키텍처 설계</strong>: &ldquo;확장성보다는 유지보수성을 우선시한다. 과도한 추상화보다는 명확하고 이해하기 쉬운 구조가 더 중요하다고 생각한다.&rdquo;
              <br /><em>구현: SOLID 원칙 적용, 의존성 주입, 인터페이스 분리, 단일 책임 원칙으로 모듈화</em>
            </li>
            <li><strong>에러 처리</strong>: &ldquo;사용자가 에러를 느끼지 못하는 것이 최고의 에러 처리다. 예측 가능한 실패 지점을 사전에 방어하는 것이 핵심이다.&rdquo;
              <br /><em>구현: Try-catch 블록, 에러 바운더리, 폴백 UI, 사용자 친화적 에러 메시지</em>
            </li>
            <li><strong>DB 설계</strong>: &ldquo;정규화와 성능 사이의 균형이 중요하다. 하지만 데이터 일관성은 절대 타협할 수 없는 부분이다.&rdquo;
